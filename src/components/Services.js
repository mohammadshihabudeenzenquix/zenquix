        ...
        <div id="services" className="py-12 bg-gray-100" >
            <section data-aos="zoom-in-down">
                    <div className="py-4 my-4">
                        ...
                        <h2 className="mx-12 mt-4 text-xl font-semibold text-center text-blue-900 lg:text-2xl">We are deeply committed to the growth and success of our clients.</h2>
                    </div>
                    ...
                    <div className="px-12" data-aos="fade-down" data-aos-delay="600">
                        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                ...
                                <Link to="/cloud-services" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                ...
                                <Link to="/Datacenter-services" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="my-4 text-2xl font-semibold text-center ">End User Services</h2>
                                    <p className="font-medium text-md">
                                ...
                                <Link to="/EndUser-services" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>    
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                <div className="m-2 text-sm text-justify">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img5} />
                                    <h2 className="my-4 text-2xl font-semibold text-center ">Software Services</h2>
                                    <p className="font-medium text-md">
                                ...
                                <Link to="/Sofware-services" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>    
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                <div className="m-2 text-sm text-justify">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img6} />
                                    <h2 className="my-4 text-2xl font-semibold text-center ">Consulting Services</h2>
                                    <p className="font-medium text-md">
                                ...
                                <Link to="/Consulting-Services" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>    
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group h-[600px]">
                                <div className="m-2 text-sm text-justify">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img7} />
                                    <h2 className="my-2 text-2xl font-semibold text-center ">IT Staff Augmentation</h2>
                                    <p className="font-medium text-md">
                                ...
                                <Link to="/ITAugmentation" className="text-blue-700 hover:underline hover:text-white">Read More</Link>
                            </div>
                            </div>                    
                        </div>
                    </div>
