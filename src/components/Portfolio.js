...
const Portfolio = () => {
    return (
        <>
            <div className="py-4 my-4" id='portfolio'>
                <h2 className="my-2 text-3xl font-bold text-center text-blue-900 uppercase">Products</h2>
                <div className='flex justify-center'>
                    <div className='w-24 mb-8 border-b-4 border-blue-900'></div>
                </div>

                <div className="px-4" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">                            
                        <div className="p-3 overflow-hidden text-gray-700 transition-all ease-in-out bg-white rounded-lg shadow-2xl duration-400 hover:scale-105 min-h-max">
                            <div className="m-2 text-sm text-justify">
                                <h4 className="h-12 my-4 mb-4 text-lg font-semibold text-center md:text-2xl">Business Management System</h4>
                                <p className="h-auto font-medium leading-5 text-md md:h-48">
                                ...
                                <div className="flex justify-center my-4">
                                    <Link to="/get-demo" className="inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg text-white bg-blue-900 shadow-xl hover:bg-blue-800 rounded-xl">
                                        Schedule Demo
                        ...
                        <div className="p-3 overflow-hidden text-gray-700 transition-all ease-in-out bg-white rounded-lg shadow-2xl duration-400 hover:scale-105">
                            <div className="m-2 text-sm text-justify">
                                <h4 className="h-12 my-4 mb-4 text-lg font-semibold text-center md:text-2xl">School Management Portal</h4>
                                <p className="h-auto font-medium leading-5 text-md md:h-48">
                                ...
                                {/* <ul className="py-8 space-y-6 border-t border-gray-300">
                                    <li className="flex items-center px-8 space-x-2">
                        ...
                        <div className="p-3 overflow-hidden text-gray-700 transition-all ease-in-out bg-white rounded-lg shadow-2xl duration-400 hover:scale-105">
                            <div className="m-2 text-sm text-justify">
                            <h4 className="h-12 my-4 mb-4 text-lg font-semibold text-center md:text-2xl">Payroll Management System</h4>
                                <p className="h-auto font-medium leading-5 text-md md:h-48">
                        ...
                        <div className="p-3 overflow-hidden text-gray-700 transition-all ease-in-out bg-white rounded-lg shadow-2xl duration-400 hover:scale-105">
                            <div className="m-2 text-sm text-justify">
                                <h4 className="h-12 my-4 mb-4 text-lg font-semibold text-center md:text-2xl">Event Management System</h4>
                                <p className="h-auto font-medium leading-5 text-md md:h-48">
